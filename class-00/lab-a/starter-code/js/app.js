...
function displayPics(){
  ...
  // The previous line of code threw an error because rando, using let, is block-scoped in the while loop. That's why it thinks that rando is undeclared, returning an error.
  console.log(viewed);
